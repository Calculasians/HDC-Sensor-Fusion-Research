...
csvwrite('GSR_proj_pos.csv',projM1_pos);
csvwrite('GSR_proj_neg.csv',projM1_neg);

csvwrite('ECG_proj_pos.csv',projM3_pos);
csvwrite('ECG_proj_neg.csv',projM3_neg);

csvwrite('EEG_proj_pos.csv',projM5_pos);
csvwrite('EEG_proj_neg.csv',projM5_neg);

im  = iMch5(1);
for i=2:1:channels_v_EEG
    im = [im; iMch5(i)];
end
csvwrite('im.csv',im);
...
fprintf ('HDC for A\n');
if (select == 1)
    [numpat, hdc_model_2] = hdctrainproj (classes, reduced_L_SAMPL_DATA_2,reduced_SAMPL_DATA_2, reduced_SAMPL_DATA_4, reduced_SAMPL_DATA_6, chAM8, iMch1, iMch3, iMch5, D, N, precision, channels_a, channels_a_ECG, channels_a_EEG,projM1_pos, projM1_neg, projM3_pos, projM3_neg, projM5_pos, projM5_neg); 
else
    [numpat, hdc_model_2] = hdctrainproj (classes, reduced_L_SAMPL_DATA_2,reduced_SAMPL_DATA_2, reduced_SAMPL_DATA_4, reduced_SAMPL_DATA_6, chAM8, iMch1, iMch3, iMch5, D, N, precision, channels_a, channels_a_ECG, channels_a_EEG,projM1_pos, projM1_neg, projM3_pos, projM3_neg, projM5_pos, projM5_neg); 
...
csvwrite('prototype_A0.csv',hdc_model_2(0));
csvwrite('prototype_A1.csv',hdc_model_2(1));

writematrix(reduced_L_TS_COMPLETE_2,'test_label_A.csv');
...
fprintf ('HDC for V\n');
if (select == 1)
    [numpat, hdc_model_1] = hdctrainproj (classes, reduced_L_SAMPL_DATA_1,reduced_SAMPL_DATA_1, reduced_SAMPL_DATA_3, reduced_SAMPL_DATA_5, chAM8, iMch1, iMch3, iMch5, D, N, precision, channels_v, channels_v_ECG, channels_v_EEG,projM1_pos,projM1_neg, projM3_pos,projM3_neg, projM5_pos,projM5_neg); 
else
    [numpat, hdc_model_1] = hdctrainproj (classes, reduced_L_SAMPL_DATA_1,reduced_SAMPL_DATA_1, reduced_SAMPL_DATA_3, reduced_SAMPL_DATA_5, chAM8, iMch1, iMch3, iMch5, D, N, precision, channels_v, channels_v_ECG, channels_v_EEG,projM1_pos,projM1_neg, projM3_pos,projM3_neg, projM5_pos,projM5_neg);
...
csvwrite('prototype_V0.csv',hdc_model_1(0));
csvwrite('prototype_V1.csv',hdc_model_1(1));

writematrix(reduced_L_TS_COMPLETE_1,'test_label_V.csv');
